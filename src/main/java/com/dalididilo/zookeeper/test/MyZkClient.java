...
public class MyZkClient {
    ...
    public static void initServer() {
        String path = "/hellozk";
        final ZkClient zkClient = new ZkClient("192.168.1.155:2181,192.168.1.155:2182,192.168.1.155:2183", 12000, 12000);
    ...
    public void send(String name) {
        ...
        try {
            socket = new Socket("192.168.1.185", Integer.parseInt(config[1]));
